...
common/log/arch/linux/CMakeFiles/arch.dir/arch.c.o: ../common/log/arch/linux/arch.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/easyboard/lon_tools/mqtt1110/mqttclient-master/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object common/log/arch/linux/CMakeFiles/arch.dir/arch.c.o"
	cd /home/easyboard/lon_tools/mqtt1110/mqttclient-master/build/common/log/arch/linux && /usr/bin/gcc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/arch.dir/arch.c.o   -c /home/easyboard/lon_tools/mqtt1110/mqttclient-master/common/log/arch/linux/arch.c
...
common/log/arch/linux/CMakeFiles/arch.dir/arch.c.i: cmake_force
	...
	cd /home/easyboard/lon_tools/mqtt1110/mqttclient-master/build/common/log/arch/linux && /usr/bin/gcc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /home/easyboard/lon_tools/mqtt1110/mqttclient-master/common/log/arch/linux/arch.c > CMakeFiles/arch.dir/arch.c.i
...
common/log/arch/linux/CMakeFiles/arch.dir/arch.c.s: cmake_force
	...
	cd /home/easyboard/lon_tools/mqtt1110/mqttclient-master/build/common/log/arch/linux && /usr/bin/gcc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /home/easyboard/lon_tools/mqtt1110/mqttclient-master/common/log/arch/linux/arch.c -o CMakeFiles/arch.dir/arch.c.s
...
lib/libarch.a: common/log/arch/linux/CMakeFiles/arch.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/easyboard/lon_tools/mqtt1110/mqttclient-master/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C static library ../../../../lib/libarch.a"
	cd /home/easyboard/lon_tools/mqtt1110/mqttclient-master/build/common/log/arch/linux && $(CMAKE_COMMAND) -P CMakeFiles/arch.dir/cmake_clean_target.cmake
	cd /home/easyboard/lon_tools/mqtt1110/mqttclient-master/build/common/log/arch/linux && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/arch.dir/link.txt --verbose=$(VERBOSE)
...
common/log/arch/linux/CMakeFiles/arch.dir/clean:
	cd /home/easyboard/lon_tools/mqtt1110/mqttclient-master/build/common/log/arch/linux && $(CMAKE_COMMAND) -P CMakeFiles/arch.dir/cmake_clean.cmake
.PHONY : common/log/arch/linux/CMakeFiles/arch.dir/clean

common/log/arch/linux/CMakeFiles/arch.dir/depend:
	cd /home/easyboard/lon_tools/mqtt1110/mqttclient-master/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/easyboard/lon_tools/mqtt1110/mqttclient-master /home/easyboard/lon_tools/mqtt1110/mqttclient-master/common/log/arch/linux /home/easyboard/lon_tools/mqtt1110/mqttclient-master/build /home/easyboard/lon_tools/mqtt1110/mqttclient-master/build/common/log/arch/linux /home/easyboard/lon_tools/mqtt1110/mqttclient-master/build/common/log/arch/linux/CMakeFiles/arch.dir/DependInfo.cmake --color=$(COLOR)
